    ...
    return (
        <div className="wrapper">
            <div className="row">
                ...
                <input id={"email"} data-testid="email_input" type={"email"} value={email} onChange={(e) => {
                    console.log(e);
            ...
            <div className="row">
                ...
                <input id={"password"} data-testid="password_input" type={"password"} value={password} onChange={(e) => setPassword(e.target.value)}></input>
            </div>
            {/* Place login error inside this div. Show the div ONLY if there are login errors. */}
            <div className="errorMessage" data-testid="error_msg">{error}</div>
            <div className="button">
                <button data-testid="button" disabled={disabledButton} onClick={handleLogin}>Login</button>
            </div>
        </div>
    );
}